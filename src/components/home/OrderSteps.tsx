  ...
  const steps = [
    {
      ...
      description:
        "Explore our range of professional-grade thinners for different applications.",
    },
    {
      number: 2,
      title: "Select Options",
      description:
        "Choose the right product, size, and quantity to meet your requirements.",
    },
    {
      number: 3,
      title: "Add to Cart",
      description:
        "Add your selected products to the shopping cart for checkout.",
    },
    {
      number: 4,
      title: "Place Order",
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Follow these simple steps to order our premium thinners online. It's
        ...
        <div className="mt-12 bg-white p-6 rounded-lg shadow-sm border border-gray-100 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex items-start">
              ...
              <p className="ml-3 text-gray-600">
                Sample options for product testing
              </p>
            </div>
            <div className="flex items-start">
              <div className="flex-shrink-0 h-5 w-5 rounded-full bg-brand-100 flex items-center justify-center mt-1">
